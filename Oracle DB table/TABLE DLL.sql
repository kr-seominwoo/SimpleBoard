...
AS
SELECT P.POST_NUMBER, P.TITLE, P.USER_ID, P.POST_DATE, P.HIT, P."LIKE", P.HASHTAGS, COUNT(C.COMMENT_NUMBER) COMMENT_COUNT
FROM POST P LEFT JOIN "COMMENT" C ON P.POST_NUMBER = C.POST_NUMBER AND C.CONTENT NOT LIKE '삭제된 댓글입니다'
GROUP BY P.POST_NUMBER, P.TITLE, P.USER_ID, P.POST_DATE, P.HIT, P."LIKE", P.HASHTAGS
